...
<head>
    ...
    <script src="{{asset('css/bootstrap-3.3.7-dist/js/bootstrap.js')}}"></script>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="#">害蟲辨識<span class="sr-only">(current)</span></a></li>
                        <li><a href="#">害蟲目錄</a></li>
                        <li><a href="#">植株目錄</a></li>
                        </li>
                    </ul>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-9 col-md-7 col-lg-8" style="background-color:blue;color:white">
                <p>
                    <h1>this is a first Bootstrap page</h1>
                </p>
            </div>
            <p>1</p>
            <p>2</p>
